# Prompt — Phase 29: AR Subledger and Reports

**Phase**: 29  
**Status**: Planned  
**Referensi utama**: `../issue_docs/issue-32-phase-29-ar-subledger-reports.md`  
...
docs/issue_docs/issue-32-phase-29-ar-subledger-reports.md
docs/praproduction_docs/spec-37-audit-13-remediation.md
docs/gap_docs/gap-10-audit-13-remediation-roadmap.md
src/modules/sales/ar/*
src/modules/reports/*
```

Jika backend berubah, baca backend `AGENTS.md` dan modul Sales/Reports yang relevan.

---

## 1. Tujuan Phase

Phase 29 memulihkan AR summary, aging, reconciliation, customer ledger, dan invoice ledger. Fokusnya adalah contract adapter dan cutoff/as-of yang benar.
...
Pastikan semua surface AR memakai adapter canonical untuk:

- buckets;
- totals;
- running balance;
- reconciliation mismatch;
- customer/invoice ledgers.
...
- AR aging/reconciliation/customer ledger/invoice ledger render;
