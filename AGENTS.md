...
| 26 | Accounting Foundation & Opening Balance | 🔧 In Progress | `prompt-phase-26-accounting-foundation-opening-balance.md` | **Slice A (Jurnal) + B (Saldo Awal) DONE.** A: A13-047/049..058/094..100 + A13-096 (safe 404). B: A13-085..093 (status error, reopened, system line totals, blocking objek, draft, FixedBottomBar, ConfirmDialog, a11y). Gate: build/lint, route-mock 22/22, backend Journal 12/12, live 3/3. Sisa: Slice C (Period Lock A13-101..106), D (Tahun Fiskal A13-107..115). A13-048 di-defer ke Reports. Lihat `tracking/phase-26-progress-report.md`. |
