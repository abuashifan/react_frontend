  ...
  return (
    ...
    >
      {primaryTabs.map((tab) => {
        ...
        const isPinnedDashboard = tab.id === 'dashboard'
        return (
          <div
            key={tab.id}
            role="tab"
            ...
            className={cn(
              ...
              'text-[13px] whitespace-nowrap border-r border-[#d9e2e5] border-b-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#5c9ead]',
              isActive
