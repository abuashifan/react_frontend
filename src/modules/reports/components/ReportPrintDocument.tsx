...
interface ReportPrintDocumentProps {
  ...
  paramLabel: string
  /** Ringkasan filter tambahan opsional, mis. "Departemen: Operasional". */
  ...
  return (
    <div className="report-print-page mx-auto bg-white" style={{ width: `${widthMm}mm`, padding: `${DEFAULT_PAGE_MARGIN_MM}mm` }}>
      <div className="report-print-header space-y-0.5 text-center">
        ...
        {filterSummary && <p className="text-[11px] text-[#64748b]">{filterSummary}</p>}
      </div>

      <div className="report-print-body mt-4">{children}</div>
