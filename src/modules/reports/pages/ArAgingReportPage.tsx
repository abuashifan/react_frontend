...
export default function ArAgingReportPage() {
  ...
  return (
    <WorkspaceLayout
      hideHeader
      toolbar={<ReportCompactBar params={activeParams ?? params} onOpenModal={() => setShowFilter(true)} mode="as_of_date" filterSummary={activeParams?.customer_id ? 'Pelanggan difilter' : undefined} />}
    >
