  ...
  const columns: ColumnDef<SalesOrder>[] = [
    {
      ...
      cell: ({ original }) => (
        <button type="button" onClick={() => navigate(`/sales/orders/${original.id}`)} className="font-medium text-[#5c9ead] hover:underline">
          {original.number}
        </button>
      ),
    },
    ...
    <WorkspaceLayout
      ...
      action={
        <PermissionGuard permission="sales.orders.create">
          <Button className="bg-[#e39774] hover:bg-[#d4845e] h-8 px-3 text-[13px]" onClick={() => navigate('/sales/orders/create')}>
    ...
    >
      <div className="relative mb-3 max-w-sm">
        ...
        <Input
          type="search"
          role="searchbox"
          aria-label="Cari nomor sales order"
          value={search}
